...
(function (global$1) {
  ...
  var config = {
  	...
  	// The storage_old module to use for reordering tests
  ...
  */
  ...
  function done() {
  	...
  	runLoggingCallbacks("done", {
  		...
  		// Clear own storage_old items if all tests passed
  ...
  Test.prototype = {
  	...
  	queue: function queue() {
  		...
  		// Prioritize previously failed tests, detected from storage_old
